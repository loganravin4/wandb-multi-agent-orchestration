...
_CODE_EVAL_SYSTEM = (
    ...
    "Score bands:\n"
    "  0-1 → Placeholder or stub only (e.g. 'return 0', 'pass', empty body, no real implementation)\n"
    "  2-4 → Genuine attempt but runtime error, wrong output, or fundamentally incorrect algorithm\n"
    "  5-6 → Correct approach with significant bugs or missing key logic\n"
    "  7-8 → Correct and mostly complete, minor issues or edge cases missed\n"
    "  9-10 → Correct, optimal complexity, handles edge cases\n\n"
